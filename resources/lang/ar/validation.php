...
return [
    ...
    */
    'custom' => [
        ...
        'user_positions.*.title' => [
            'required' => 'الحقل منصب مطلوب.'
        ],
        'userSkills.*.title' => [
            'required' => 'الحقل مهارات مطلوب.'
        ],
    ],
    /*
    |--------------------------------------------------------------------------
